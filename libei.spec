...
Source0  : https://gitlab.freedesktop.org/libinput/libei/-/archive/1.4.1/libei-1.4.1.tar.gz
...
%prep
%setup -q -n libei-1.4.1
cd %{_builddir}/libei-1.4.1
pushd ..
cp -a libei-1.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743515860
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libei.so.1.4.1
/V3/usr/lib64/libeis.so.1.4.1
/V3/usr/lib64/liboeffis.so.1.4.1
/usr/lib64/libei.so.1
/usr/lib64/libei.so.1.4.1
/usr/lib64/libeis.so.1
/usr/lib64/libeis.so.1.4.1
/usr/lib64/liboeffis.so.1
/usr/lib64/liboeffis.so.1.4.1
